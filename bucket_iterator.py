...
class BucketIterator(object):
    ...
    def pad_data(self, batch_data):
        ...
        return { \
            ...
            'cos_graph': torch.tensor(batch_cos_graph),\
            'dep_graph': torch.tensor(batch_dep_graph),\
        }
